...
const exampleDataList = [
  ...
  { id: 1,type:'text',text: 'Fold dough',complete: false,draggable: true,time: 0},
  { id: 2,type:'timer',text: '',complete: false,draggable: true,time: 60},
  { id: 3,type:'text',text: 'Fold dough',complete: false,draggable: true,time: 0},
  { id: 4,type:'timer',text: '',complete: false,draggable: true,time: 30},
  { id: 5,type:'text',text: 'Fold dough',complete: false,draggable: true,time: 0},
  { id: 4,type:'timer',text: '',complete: false,draggable: true,time: 30},
